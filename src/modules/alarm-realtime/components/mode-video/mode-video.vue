<template>
  <alarm-layout>
    <template v-slot:content>
      ...
      <!-- 视频容器 -->
      <div class="multi-videos-container">
        <multi-videos-container
...
import MultiVideosContainer from './multi-videos-container';
...
export default {
  ...
  methods: {
    ...
    onDeviceChange(devices) {
      if (this.$refs.captureList) this.$refs.captureList.updateCamera(devices);
    },
    /**
     * 显示告警详情
